<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:58:"D:\php01\public/../application/index\view\index\index.html";i:1515048462;s:60:"D:\php01\public/../application/index\view\common\header.html";i:1519208017;s:59:"D:\php01\public/../application/index\view\common\right.html";i:1475987682;s:58:"D:\php01\public/../application/index\view\common\foot.html";i:1515312214;}*/ ?>
...
<body>
        <div class="ladytop">
            <div class="nav">
                <div class="left"><a href=""><img src="__INDEX__/images
/hunshang.png" alt="wed114婚尚"></a></div>
                <div class="right">
                    <div class="box">
                    <a href="<?php echo url('http://www.php01.com/index/index'); ?>"  rel='dropmenu209'>首页</a>
...
<div class="hotmenu">
	<div class="con">热门标签：
    <a href="http://www.baidu.com" target="_blank" style="color:#f00;">如果做一个合格的phper</a>
    ...
    <a href='http://www.php01.com/public/index.php/index/search/index?keywords=<?php echo $vo['tagname']; ?>'><?php echo $vo['tagname']; ?></a>
    <?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
</div>
...
<div class="overall">
	...
	<div class="left">
		...
		<?php
			...
			foreach ($arr as $k=>$v) {
				echo "<a href='http://www.php01.com/public/index.php/index/search/index?keywords=$v'>$v</a>";
			}
		?>
		</div>
				</div>
...
<div class="footerd">
<ul>
<li>CopyRight &#169; 20017-2018 版权所有   <a href="http://www.baidu.com" target="_blank" rel="nofollow">桂ICP备888888号</a></li>
</ul>
</div>
